...
export default {
    ...
    methods: {
        enviarForm: function(evt){
            ...
            this.$http.post('http://localhost:3000/empresa/cadastrar', formData)
            .then(res => {
                this.showAlert(res);
            });
        },
        ...
        buscaDados: function (id){
            this.$http.get('http://localhost:3000/empresa/visualizar', {params: {id: id}}).
            then(res => res.json()).then(empresa => {
